...
import { Play, Pause, RotateCcw, Loader2, AudioLines } from 'lucide-react';
    ...
    <div className="fixed bottom-0 left-0 right-0 z-50">
      <div className="bg-background/80 backdrop-blur-xl border-t border-white/5 px-4 md:px-8 py-3 md:py-4 flex items-center gap-4 md:gap-8 shadow-[0_-10px_40px_rgba(0,0,0,0.3)]">
        ...
        <button
          ...
          className="w-12 h-12 flex-shrink-0 flex items-center justify-center rounded-full bg-primary text-primary-foreground hover:scale-105 transition-all shadow-xl shadow-primary/20 active:scale-95 group relative overflow-hidden"
        >
        ...
        <div className="flex-1 flex flex-col gap-1.5">
          <div className="flex justify-between items-baseline">
            <div className="flex items-center gap-2 md:gap-3">
              <span className="text-[10px] font-black text-primary uppercase tracking-[0.1em] md:tracking-[0.3em] whitespace-nowrap">Actor–Observer Effect</span>
              <span className="text-xs font-bold text-foreground opacity-60 tracking-tight italic hidden sm:inline">A psychology study guide</span>
            </div>
